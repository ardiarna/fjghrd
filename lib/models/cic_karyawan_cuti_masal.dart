...
class CicKaryawanCutiMasal {
  ...
  factory CicKaryawanCutiMasal.fromMap(Map<String, dynamic> map) {
    return CicKaryawanCutiMasal(
      karyawanId: map['cic_karyawan_id'].toString(),
