...
class PendidikanForm extends StatelessWidget {
  final String id;
  const PendidikanForm({super.key, required this.id});

  @override
  Widget build(BuildContext context) {
    final controller = Get.find<PendidikanControl>();
    
    Pendidikan item = id == '' ? Pendidikan() : controller.listPendidikan.where((element) => element.id == id).first;
...
void showPendidikanForm(String id) {
  AFwidget.dialog(
    PendidikanForm(id: id),
