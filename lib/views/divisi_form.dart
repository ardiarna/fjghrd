...
class DivisiForm extends StatelessWidget {
  final String id;
  const DivisiForm({super.key, required this.id});

  @override
  Widget build(BuildContext context) {
    final controller = Get.find<DivisiControl>();
    
    var item = id == '' ? Divisi() : controller.listDivisi.where((element) => element.id == id).first;
