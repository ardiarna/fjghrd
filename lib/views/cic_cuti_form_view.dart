...
class CicCutiFormView extends StatelessWidget {
  final String formType;
  CicCutiFormView({super.key, required this.formType});
  ...
  Widget build(BuildContext context) {
    ...
    String title = 'Form Cuti CIC ${controller.filterTahun.label}';
    if(formType == 'IJIN') title = 'Form Ijin CIC ${controller.filterTahun.label}';
                  ...
                  if(controller.currentId != '') ...[
                    ...
                    if (controller.formType == 'CUTI') ...[
                      ...
                      ElevatedButton.icon(
                        ...
                        onPressed: () async {
                            AFwidget.loading();
                            var hasil = await AFdatabase.download(url: 'cic/cuti/excel/form/${controller.currentId}');
                            Get.back();
                            if(hasil.success) {
