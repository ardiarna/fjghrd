...
class AgamaForm extends StatelessWidget {
  final String id;
  const AgamaForm({super.key, required this.id});

  @override
  Widget build(BuildContext context) {
    final controller = Get.find<AgamaControl>();
    Agama item = id == '' ? Agama() : controller.listAgama.firstWhere((element) => element.id == id, orElse: () => Agama());
