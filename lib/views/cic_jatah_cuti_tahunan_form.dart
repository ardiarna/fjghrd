...
class CicJatahCutiTahunanForm extends StatelessWidget {
  const CicJatahCutiTahunanForm({super.key});
...
void showCicJatahCutiTahunanForm(String id, {String? defaultKaryawanId, String? defaultKaryawanNama, String? defaultTahun}) {
  final controller = Get.find<CicCutiControl>();
