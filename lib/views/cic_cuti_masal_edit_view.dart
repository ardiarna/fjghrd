import 'package:fjghrd/controllers/cic_cuti_masal_control.dart';
import 'package:fjghrd/controllers/cic_cuti_control.dart';
import 'package:fjghrd/utils/af_widget.dart';
import 'package:fjghrd/utils/af_convert.dart';
import 'package:fjghrd/views/cic_cuti_masal_tambah_karyawan_view.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:fjghrd/models/cuti.dart';
import 'package:fjghrd/views/cic_cuti_form_view.dart';

class CicCutiMasalEditView extends StatelessWidget {
  final String id;
  const CicCutiMasalEditView({super.key, required this.id});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<CicCutiMasalControl>(
      init: CicCutiMasalControl(editId: id),
      builder: (controller) {
        return Scaffold(
          body: Column(
            children: [
              AFwidget.pageHeader(
                title: 'EDIT CUTI MASAL CIC',
                icon: Icons.groups,
                onBack: () {
  ...
  Widget _buildTopSection(BuildContext context, CicCutiMasalControl controller) {
  ...
  Widget _buildTableSection(BuildContext context, CicCutiMasalControl controller) {
    if (controller.dataMasal == null) return const SizedBox();
    
    var filteredList = controller.listCutiEdit.where((c) {
      String nama = (c['cic_karyawan'] ?? c['karyawan'])['nama'].toString().toLowerCase();
                ...
                child: Center(
                  child: IconButton(
                    ...
                    onPressed: () {
                      ...
                      AFwidget.dialog(
                        CicCutiMasalTambahKaryawanView(
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: filteredList.map((cuti) {
                var karyawan = cuti['cic_karyawan'] ?? cuti['karyawan'];
                          ...
                          children: [
                            IconButton(
                              onPressed: () {
                                ...
                                if (Get.isRegistered<CicCutiControl>()) {
                                  Get.find<CicCutiControl>().editForm(id, cutiObj: objCuti);
                                }
                                _openForm(jenisForm);
                              },
  ...
  Widget _buildBottomAction(CicCutiMasalControl controller) {
    return Container(
