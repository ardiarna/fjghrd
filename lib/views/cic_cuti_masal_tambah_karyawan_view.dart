...
class CicCutiMasalTambahKaryawanView extends StatelessWidget {
  final String masalId;
  final Map<String, dynamic> dataMasal;

  const CicCutiMasalTambahKaryawanView({super.key, required this.masalId, required this.dataMasal});
      ...
      builder: (controller) {
        return Container(
          ...
          child: Column(
            ...
            children: [
              AFwidget.formHeader('TAMBAH KARYAWAN CIC'),
              Padding(
                          ...
                          Expanded(
                            child: AFwidget.comboField(
                              ...
                              onTap: () async {
                                ...
                                var cc = Get.find<CicCutiControl>();
