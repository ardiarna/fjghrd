...
class PotonganControl extends GetxController {
  ...
  String get pesanValidasi {
    ...
    if(jenis.value.isEmpty) return 'Silakan pilih jenis potongan';
    if(karyawan.id.isEmpty) return 'Silakan pilih karyawan';
    if((jenis.value == 'TB' || jenis.value == 'UL') && txtHari.text.isEmpty) return 'Jumlah hari harus diisi';
